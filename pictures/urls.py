...
urlpatterns = [
    ...
    path('profile/settings/personal-information/', views.edit_profile, name='settings-personal'),
    ...
    path('<str:username>/collections/', views.view_profile_collections, name='view-profile-collections'),
