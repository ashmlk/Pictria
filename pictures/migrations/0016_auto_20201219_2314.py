...
class Migration(migrations.Migration):
    ...
    dependencies = [("pictures", "0015_auto_20201219_1945")]
    ...
    operations = [
        ...
        migrations.AlterModelManagers(
            name="profile", managers=[("objects", pictures.models.ProfileManager())]
        ),
        migrations.RemoveField(model_name="images", name="collection"),
        migrations.AddField(
            model_name="images",
            name="views",
